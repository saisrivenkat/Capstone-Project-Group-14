...
export const SEND_STOCKMAIL_REQUEST = 'SEND_STOCKMAIL_REQUEST'
export const SEND_STOCKMAIL_SUCCESS = 'SEND_STOCKMAIL_SUCCESS'
export const SEND_STOCKMAIL_RESET = 'SEND_STOCKMAIL_RESET'
export const SEND_STOCKMAIL_FAIL = 'SEND_STOCKMAIL_FAIL'
